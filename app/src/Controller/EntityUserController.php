...
{
    /**
     * @Route("/", name="entity_user_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="entity_user_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="entity_user_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="entity_user_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="entity_user_delete", methods={"DELETE"})
     */
